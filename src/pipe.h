...
typedef struct Pipe_State {
    ...
    /* icache */
    cache_t *icache;
    int icache_bubbles; /* currently stalling for a miss? */

    /* dcache */
    cache_t *dcache;
    int dcache_bubbles; /* currently stalling for a miss? */
...
/* global variable -- pipeline states */
extern Pipe_State pipe[4];
